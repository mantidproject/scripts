###########################################################################
#  14/8/9 attempt to get neutrons PER UAMPHR vs  WAVELENGTH (i.e. final rebin to Q is commented out)
...
# R=80 to 220, run  6100    copy RAW file to path directory below
