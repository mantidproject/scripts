...
# 28/04/10 Rmax reduced from 280 to 220
...
run_integer = 53335
prefix = 'LOQ'
run_no = str(run_integer)
extRaw = '.raw'
ext = '.raw'
# choose LOQ detector HERE ++++++++++++++++++++++++++++++++++++++++++
...
# run 626   25848
det = wksp.getDetector(8258)
# then check the coords for the shift 
out=str(det.getPos())
# NEED to read X&Y coords from string "out" here 
print "det 8258 is  "+out 
det = wksp.getDetector(8258+60)
out=str(det.getPos())
print "det 8258+60 is  "+out 
