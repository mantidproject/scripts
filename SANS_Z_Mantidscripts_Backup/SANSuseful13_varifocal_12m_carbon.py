...
maskfilename="z:/Masks/masksans2d_123P_12m_M3_test11.txt"
# pull in the direct beam that we need to modify MAKE SURE IT IS THE SAME AS IN THE MASK FILE !
LoadRKH(      "z:/Masks/DIRECTM1_15785_12m_31Oct12_v11.dat","directbeam")
newdirectfile="Z:/Masks/DIRECTM1_15785_12m_31Oct12_v12.dat"
rsam="15785-add"
rcan="15784-add"
tsam="15779"
tdb="15778"
...
wksp="0p7M_NaBr_DTAB"
tag="_F"
Rebin(wksp+tag,"ratio","0.05888,-0.08,0.91")
Rebin(wksp,"den","0.05888,-0.08,0.91")
Divide("ratio","den",wksp+"_FbyR")
