...
#
#  ================================================ INPUT DATA HERE =================================     
DataPath("Y:/cycle_12_1/")
samplefilename='SANS2d00013438'
# list of times to slice between,
slicelist=[0,600,1200,1800,2400,3000]
slicelist=[3000,3600,4200,4800,5400,6000]
slicelist=[0,60,120,180,240]
slicelist=[300,301,302,303,304]
