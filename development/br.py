...
class br():
    ...
    def help(self,**kwargs):
        ...
        if len(kwargs) == 0:
            ...
            print "Where parameters are the option specific values namely: "
            print ""
            print "br debug|release|DebWithRelInfo [fast]  -- build debug/release/debug with release version of the build"
            print "Where ""fast"" if present means minimal rebuild. The build occurs for the branch and repository you are currently in."
