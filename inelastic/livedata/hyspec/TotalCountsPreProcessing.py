...
ei = mtd['Live:TotalCounts'].getRun().getLogData('Ei').value if mtd.workspaceExists('Live:TotalCounts') else GetEi(InputWorkspace=input,FixEi='1').getPropertyValue('IncidentEnergy')
